...
Public Class BarCode
    ...
    Private NombreArchivoBMPSet As String
    Private DatoSet As String
    Private DescCarpetaSet As String
    Private Pic1 As PictureBox
    Private bmT As Image
...
#Region "Propiedades"
    ...
    Public Property NombreArchivoBMP() As String
        Get
            NombreArchivoBMP = NombreArchivoBMPSet
        End Get

        Set(ByVal value As String)
            NombreArchivoBMPSet = value
        End Set
    End Property

    Public WriteOnly Property Dato() As String
        Set(ByVal value As String)
            DatoSet = value
        End Set
    End Property

    Public WriteOnly Property DescCarpeta As String
        Set(value As String)
            DescCarpetaSet = value
        End Set
    End Property
...
#Region "Guardar"
    ...
    Public Sub Guardar(ByVal Image As Bitmap)
        Try

            If Image Is Nothing Then
                MsgBox("Error en imagen generada", vbCritical)
                Return
            End If

            If DescCarpetaSet.ToString = "" Or NombreArchivoBMPSet = "" Then
                MsgBox("Error en ruta archivo", vbCritical)
                Return
            End If

            If Not Directory.Exists("C:\ImgChr\" + DescCarpetaSet) Then
                Directory.CreateDirectory("C:\ImgChr\" + DescCarpetaSet)
            End If
            If File.Exists("C:\ImgChr\" + DescCarpetaSet + "\" + NombreArchivoBMPSet) Then Kill("C:\ImgChr\" + DescCarpetaSet + "\" + NombreArchivoBMPSet)
            Pic1 = New PictureBox
            Pic1.Image = bmT

            Pic1.Image.Save("C:\ImgChr\" + DescCarpetaSet + "\" + NombreArchivoBMPSet)
        Catch ex As Exception
            MsgError(ex)
        End Try
